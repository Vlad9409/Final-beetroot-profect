    ...
    <div class="container">
        ...
        <div class="burder-menu">
          <ul class="burger-container">
            <li class="burger-text__first">
              <a class="burger-title" href="#">Features</a>
            </li>
            <li class="burger-text">
              <a class="burger-title" href="#">Tehnoligies</a>
            </li>
            <li class="burger-text">
              <a class="burger-title" href="#">Who we are</a>
            </li>
            <li class="burger-text">
              <a class="burger-title" href="#">How do we deliver</a>
            </li>
          </ul>
        </div>
        <div class="btn">
      ...
      <div class="tittle">
        <div class="tittle-text">
          <h1 class="tittle-text__main">ESSENTIAL BLOGGER</h1>
          <div class="tittle-second">
            <h2 class="tittle-text__second">
              Essential lens, filters, and cases for drones
            </h2>
          </div>
...
.header {
  ...
  background: url(../assets/Rectangle-22.svg) no-repeat;
}
